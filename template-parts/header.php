...
<head>
	...
	<meta name="apple-mobile-web-app-title" content="Client Octopus" />
		...
		<div class="site-header__inner">
			<div class="container">
				...
				<div class="site-header__bar">
					<a href="/" class="site-logo" aria-label="Client Octopus home">
						<?php include_asset('static/logo-inline.svg'); ?>
					</a>
